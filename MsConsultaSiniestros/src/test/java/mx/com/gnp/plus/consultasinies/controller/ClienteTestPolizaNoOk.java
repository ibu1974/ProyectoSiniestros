...
@ActiveProfiles("test")
public class ClienteTestPolizaNoOk {
	@LocalServerPort
    private int port;
	...
	public void consultaSiniestrosporPolizaNoOk() throws ExceptionEot{
		...
		ResponseEntity<ConsultaSiniestrosResponse> response = template.getForEntity("/Consultas/consultarSiniestros?cdnumpol=00000373642421&cdtipusu=EMP&insaneam=N&feocusin=0",  ConsultaSiniestrosResponse.class);
